...
Link to excel template:https://cgiar-my.sharepoint.com/:x:/r/personal/p_steward_cgiar_org/Documents/ERA/Data%20Entry/Data%20Entry%202023/Excel%20Template/V2.0.28%20-%20Industrious%20Elephant.xlsm?d=w7b6da0ee08c74bc5acc0567c23a2a79e&csf=1&web=1&e=LErfWY
...
2020 s3://digital-atlas/era/data_entry/majestic_hippo_2020/excel_files/majestic_hippo_2020.zip
2022 s3://digital-atlas/era/data_entry/skinny_cow_2022/excel_files/skinny_cow_2022.zip
2023 s3://digital-atlas/era/data_entry/industrious_elephant_2023/excel_files/industrious_elephant_2023.zip

## How data were imported
### ERA github
The code used to import and compile the dataset from the excel files is in the ERAg R package using R 4.2.1 (R Development Team) and may be downloaded from GitHub https://github.com/CIAT/ERA_dev. This github is under continual development. Here are some examples of the types of functionality provided and documented:
...
Data is available and can be downloaded from the S3 Bucket as it follows : 
...
## Import ERA vocabulary
This excel workbook is the source of truth for the controlled ERA vocabularly, one of the most useful tables containes meta-data that describes the fields in the ERA tables (see the 'Tables' object created above) the table is called 'era_fields_vs'
```{r import ERA vocab}
...
DT::datatable(
  metadata[Table==selected_table,!"Table"], # filter to selected table
...
## Duration of Long-Term Experiments

To effectively visualize the duration of Long Term Experiments, we grouped them into categorized duration ranges. This approach helps organize the experiments into manageable categories, allowing us to create a clear and easily interpretable plot, especially given the large volume of papers in our dataset. 
